...
static const struct ch13726a_desc mecha_comet_desc = {
    .modes = mecha_comet_modes,
    .num_modes = ARRAY_SIZE(mecha_comet_modes),
    .width_mm = 65,
    .height_mm = 75,
    .bpc = 8,
};
...
static const struct of_device_id ch13726a_of_match[] = {
    ...
    { .compatible = "mecha,comet", .data = &mecha_comet_desc},
	{ /* sentinel */ }
};
